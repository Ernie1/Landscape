...
//		Image src1 = implementImageIO.myRead("bmptest/1.bmp");
//		Image src2 = implementImageIO.myRead("bmptest/2.bmp");
//	}
//
//	@Test
//	void testShowChanelR() throws IOException {
//		BufferedImage my1 = ToBufferedImage.toBufferedImage(imageProcessor.showChanelR(src1));
//		BufferedImage my2 = ToBufferedImage.toBufferedImage(imageProcessor.showChanelR(src2));
//		BufferedImage goal1 = ToBufferedImage.toBufferedImage(implementImageIO.myRead("bmptest/goal/1_red_goal.bmp"));
//		BufferedImage goal2 = ToBufferedImage.toBufferedImage(implementImageIO.myRead("bmptest/goal/2_red_goal.bmp"));
//		
//		assertEquals(my1.getWidth(),goal1.getWidth());
//		assertEquals(my1.getHeight(),goal1.getHeight());
//		assertEquals(my1.getWidth(),goal1.getWidth());
