...
/**
 * A <code>Jumper</code> is an actor can move forward two cells in each move. It “jumps” over rocks and flowers. It does not leave anything behind it when it jumps. <br />
